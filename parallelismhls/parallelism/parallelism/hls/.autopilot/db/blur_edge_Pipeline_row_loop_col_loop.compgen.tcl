...
set name blur_edge_urem_31ns_4ns_3_35_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler blur_edge_sparsemux_11_3_8_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {auto}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler blur_edge_sparsemux_9_3_8_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {auto}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler blur_edge_sparsemux_7_3_8_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {auto}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler blur_edge_blur_edge_Pipeline_row_loop_col_loop_blur_edge_stream_stream_axis_0_int_int_ibkb BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
set InstName blur_edge_flow_control_loop_pipe_sequential_init_U
set CompName blur_edge_flow_control_loop_pipe_sequential_init
