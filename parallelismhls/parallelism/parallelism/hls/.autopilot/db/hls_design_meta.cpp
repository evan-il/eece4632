...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("dst_TDATA", 8, hls_out, 7, "axis", "out_data", 1),
	Port_Property("dst_TVALID", 1, hls_out, 13, "axis", "out_vld", 1),
	Port_Property("dst_TREADY", 1, hls_in, 13, "axis", "out_acc", 1),
	Port_Property("dst_TKEEP", 1, hls_out, 8, "axis", "out_data", 1),
	Port_Property("dst_TSTRB", 1, hls_out, 9, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "blur_edge";
